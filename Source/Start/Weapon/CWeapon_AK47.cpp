...
ACWeapon_AK47::ACWeapon_AK47()
{
	...
	//Equip
	{
		...
		static ConstructorHelpers::FObjectFinder<UAnimMontage> montage(TEXT("/Script/Engine.AnimMontage'/Game/Assets/Montages/Rifle/Equip_Rifle_Standing_Montage.Equip_Rifle_Standing_Montage'"));
